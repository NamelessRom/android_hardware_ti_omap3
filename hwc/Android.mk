...
LOCAL_C_INCLUDE := $(TARGET_OUT_INTERMEDIATES)/KERNEL_OBJ/usr/include
...
ifeq ($(TARGET_OMAP3_HWC_DISABLE_YUV_OVERLAY),true)
	LOCAL_CFLAGS += -DOMAP3_HWC_DISABLE_YUV_OVERLAY
endif

ifeq ($(TARGET_OMAP3_HWC_BOOTLOADER_DISPLAY_INIT),true)
	LOCAL_CFLAGS += -DOMAP3_HWC_BOOTLOADER_DISPLAY_INIT
endif
